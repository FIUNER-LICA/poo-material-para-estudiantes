class Contacto:
    ...
    def __del__(self):
        print("se invoca destructor de Contacto")
        del self.__nombre
        del self.__nro_telefono
        del self.__correo_electronico
...
class AgendaDeContactos:
    ...
    def __del__(self):
        print("se invoca destructor de AgendaDeContactos")
        del self.__contactos
...
if __name__ == "__main__":
    ...
    # borrado "manual" de objetos AgendaDeContactos
    del agenda1 
    del agenda2
