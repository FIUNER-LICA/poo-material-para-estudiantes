...
"""
Ejemplo de polimorfismo sin jerarquía (Duck Typing).
"""
...
class Flauta:
    def ejecutar(self):
        ...
        c = 4 # una variable cualquiera que solo existe en el contexto del método ejecutar de la clase Flauta
...
class MartilloNeumatico:
    def ejecutar(self):
        print("ejecutar máquina: martillo neumático")
